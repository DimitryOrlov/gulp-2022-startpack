...
export const clearFonts = () => {
    return deleteAsync(app.path.build.fonts);
}
...
export const fontsStyle = () => {
    ...
    fs.readdir(app.path.build.fonts, function(err, fontsFiles) {
        if(fontsFiles) {
            // Проверяем существует ли файл для стилей для подключенных шрифтов
                ...
                for(var i = 0; i < fontsFiles.length; i++) {
                    ...
                    if(newFileOnly !== fontFileName) {
                        ...
                        if(fontWeight.toLowerCase() === 'thin') {
                            ...
                            fontWeight = 700;
                        } else if(fontWeight.toLowerCase() === 'extrabold' || fontWeight.toLowerCase() === '') {
                            fontWeight = 800;
